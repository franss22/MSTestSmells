...
{
    [TestClass]
    public class AssertionRouletteAreNotEqualUnitTests

    {
        ...
        private readonly TestReader testReader = new TestReader("AssertionRoulette", "Corpus", "AreNotEqual");
        ...
        {
            var expected1st = VerifyCS.Diagnostic("AssertionRoulette").WithSpan(13, 13, 13, 37).WithArguments("AreNotEqual");
        ...
        public async Task DoubleAssertIntNoMessageSecond()
        {
            ...
            var expected2nd = VerifyCS.Diagnostic("AssertionRoulette").WithSpan(17, 13, 17, 37).WithArguments("AreNotEqual");
        ...
        {
            var expected1st = VerifyCS.Diagnostic("AssertionRoulette").WithSpan(13, 13, 13, 44).WithArguments("AreNotEqual");
        ...
        public async Task DoubleAssertStringNoMessageSecond()
        {
            ...
            var expected2nd = VerifyCS.Diagnostic("AssertionRoulette").WithSpan(17, 13, 17, 44).WithArguments("AreNotEqual");
        ...
        {
            var expected1st = VerifyCS.Diagnostic("AssertionRoulette").WithSpan(15, 13, 15, 54).WithArguments("AreNotEqual");
        ...
        public async Task DoubleAssertStringCultureInfoNoMessageSecond()
        {
            ...
            var expected2nd = VerifyCS.Diagnostic("AssertionRoulette").WithSpan(19, 13, 19, 54).WithArguments("AreNotEqual");
